...
public class LtreeDecompress extends AbstractRoutine<Object> {
     ...
     */
    public LtreeDecompress() {
        super("ltree_decompress", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
     ...
     */
    public LtreeDecompress set__1(Field<Object> field) {
        setField(_1, field);
        return this;
    }
}
