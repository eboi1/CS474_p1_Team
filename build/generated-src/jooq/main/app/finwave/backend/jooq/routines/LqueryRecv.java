...
public class LqueryRecv extends AbstractRoutine<Object> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"lquery\""), false, false);
     ...
     */
    public LqueryRecv() {
        super("lquery_recv", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"lquery\""));
     ...
     */
    public LqueryRecv set__1(Field<Object> field) {
        setField(_1, field);
        return this;
    }
}
