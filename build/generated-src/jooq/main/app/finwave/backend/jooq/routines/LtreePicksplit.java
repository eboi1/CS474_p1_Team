...
public class LtreePicksplit extends AbstractRoutine<Object> {
     ...
     */
    public LtreePicksplit() {
        super("ltree_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
     ...
     */
    public LtreePicksplit set__1(Field<Object> field) {
        setField(_1, field);
        return this;
    }
     ...
     * {@link org.jooq.Select} statement
     */
    public LtreePicksplit set__2(Field<Object> field) {
        setField(_2, field);
        return this;
    }
}
