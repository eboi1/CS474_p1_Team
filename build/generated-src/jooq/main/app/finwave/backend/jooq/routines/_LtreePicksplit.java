...
public class _LtreePicksplit extends AbstractRoutine<Object> {
     ...
     */
    public _LtreePicksplit() {
        super("_ltree_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
     ...
     */
    public _LtreePicksplit set__1(Field<Object> field) {
        setField(_1, field);
        return this;
    }
     ...
     * {@link org.jooq.Select} statement
     */
    public _LtreePicksplit set__2(Field<Object> field) {
        setField(_2, field);
        return this;
    }
}
