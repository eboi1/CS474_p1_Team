...
public class LqueryIn extends AbstractRoutine<Object> {
     ...
     */
    public LqueryIn() {
        super("lquery_in", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"lquery\""));
     ...
     */
    public LqueryIn set__1(Field<Object> field) {
        setField(_1, field);
        return this;
    }
}
