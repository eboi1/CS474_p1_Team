...
public class LtreeOut extends AbstractRoutine<Object> {
     ...
     */
    public LtreeOut() {
        super("ltree_out", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
     ...
     */
    public LtreeOut set__1(Field<Ltree> field) {
        setField(_1, field);
        return this;
    }
}
