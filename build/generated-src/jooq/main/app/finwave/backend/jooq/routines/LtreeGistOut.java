...
public class LtreeGistOut extends AbstractRoutine<Object> {
     ...
     */
    public LtreeGistOut() {
        super("ltree_gist_out", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
     ...
     */
    public LtreeGistOut set__1(Field<Object> field) {
        setField(_1, field);
        return this;
    }
}
